...
export default function BackgroundNetwork() {
  return (
    <div
      className="bg-network fixed inset-0 z-0 pointer-events-none opacity-45"
      aria-hidden="true"
    >
      <svg viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice">
        ...
        <g>
          ...
          <circle className="node" cx="180" cy="180" r="7" fill="#0f766e" opacity="0.55" />

          <circle className="node" cx="560" cy="240" r="48" fill="url(#nodeGlow)" />
          <circle className="node" cx="560" cy="240" r="9" fill="#d97706" opacity="0.75" />

          <circle className="node" cx="920" cy="310" r="42" fill="url(#nodeGlow)" />
          <circle className="node" cx="920" cy="310" r="8" fill="#0f766e" opacity="0.5" />

          <circle className="node" cx="420" cy="520" r="36" fill="url(#nodeGlow)" />
          <circle className="node" cx="420" cy="520" r="6" fill="#0f766e" opacity="0.65" />

          <circle className="node" cx="700" cy="580" r="44" fill="url(#nodeGlow)" />
          <circle className="node" cx="700" cy="580" r="8" fill="#4f6078" opacity="0.55" />

          <circle className="node" cx="1100" cy="140" r="28" fill="url(#nodeGlow)" />
          <circle className="node" cx="1100" cy="140" r="5" fill="#d97706" opacity="0.55" />
        </g>
